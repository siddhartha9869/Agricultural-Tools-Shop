      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="category" id="category" required class="box">
               <option value="smallmch">Small Machinaries</option>
               <option value="largemch">Large Machinaries</option>
               <option value="handmch">Hand Tools</option>
               <option value="smartmch">Smart Tools</option>
            </select>
         </div>
         <div class="inputBox">
